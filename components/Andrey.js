...
export default class AddScreenCar extends React.Component {
  state = {
    coords : '',
    from : '',
    to : '',
...
// transforms something like this geocFltrhVvDsEtA}ApSsVrDaEvAcBSYOS_@... to an array of coordinates
  ...
  carOffsetDonationCalculation(distance) {
    cost = ((distance * .000001201) * 1.34).toFixed(2);
    if (cost < 0.30) {
...
/>
          <Button style={styles.bottomButtonDonate} title={this.state.donate} backgroundColor='#D8EBFF' icon={{name: 'currency-usd', type: 'material-community'}} onPress={this.onButtonPressSearchDirections.bind(this)}/>
